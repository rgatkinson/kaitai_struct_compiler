...
abstract class LanguageCompiler(
  ...
  def readAssignmentsHeader(endian: Option[FixedEndian], isEmpty: Boolean): Unit = {}
  def readAssignmentsBody(defEndian: Option[Endianness]): Unit = {}
  def readAssignmentsFooter(): Unit = {}
